...
* URL de votre dépôt <https://forge.univ-lyon1.fr/p1910980/projetlifap5.git>
* BANGOURA Mohamed #1
* Nom de votre application (Brain Games)
...
*Pour une meilleur compréhension, n'est il pas mieux d'afficher une barre de progression pour voir si l'utilisateur 
a répondu a toutes les questions ou pas(comme je l'ai fait dans l'onglet mesQuizzes=>Répondants)
*Ce projet m'a été particulièrement très important, je remercie l'équipe pédagogique LIFAP5.
